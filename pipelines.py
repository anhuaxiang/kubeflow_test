...
confusion_matrix_op = components.load_component_from_url(
    'https://raw.githubusercontent.com/kubeflow/pipelines/2e52e54166795d20e92d287bde7b800b181eda02/components/local/confusion_matrix/component.yaml')
roc_op = components.load_component_from_url(
    'https://raw.githubusercontent.com/kubeflow/pipelines/2e52e54166795d20e92d287bde7b800b181eda02/components/local/roc/component.yaml')
...
def dataproc_create_cluster_op(
    ...
    return dsl.ContainerOp(
        ...
        image='gcr.io/ml-pipeline/ml-pipeline-dataproc-create-cluster:2d0d8619507743ec4ff1e213735a8f82d3913281',
        arguments=[
            '--project', project,
            '--region', region,
            '--name', cluster_name,
...
def dataproc_delete_cluster_op(
    ...
    return dsl.ContainerOp(
        ...
        image='gcr.io/ml-pipeline/ml-pipeline-dataproc-delete-cluster:2d0d8619507743ec4ff1e213735a8f82d3913281',
        arguments=[
            '--project', project,
            '--region', region,
            '--name', cluster_name,
...
def dataproc_analyze_op(
    ...
    return dsl.ContainerOp(
        ...
        image='gcr.io/ml-pipeline/ml-pipeline-dataproc-analyze:2d0d8619507743ec4ff1e213735a8f82d3913281',
        arguments=[
            '--project', project,
            '--region', region,
...
def dataproc_transform_op(
    ...
    return dsl.ContainerOp(
        ...
        image='gcr.io/ml-pipeline/ml-pipeline-dataproc-transform:2d0d8619507743ec4ff1e213735a8f82d3913281',
        arguments=[
            '--project', project,
            '--region', region,
            '--cluster', cluster_name,
...
def dataproc_train_op(
    ...
    return dsl.ContainerOp(
        ...
        image='gcr.io/ml-pipeline/ml-pipeline-dataproc-train:2d0d8619507743ec4ff1e213735a8f82d3913281',
        arguments=[
            '--project', project,
            '--region', region,
            '--cluster', cluster_name,
...
def dataproc_predict_op(
    ...
    return dsl.ContainerOp(
        ...
        image='gcr.io/ml-pipeline/ml-pipeline-dataproc-predict:2d0d8619507743ec4ff1e213735a8f82d3913281',
        arguments=[
            '--project', project,
            '--region', region,
            '--cluster', cluster_name,
